            ...
            @foreach ($promos as $promo)
                <div class="flex flex-col justify-center gap-4 rounded-lg" data-aos="fade-up">
                    <div class="overflow-hidden bg-center bg-cover rounded-lg cursor-pointer h-52 md:h-60 lg:h-80 group"
                        style="background-image:url('storage/category/bakpia.png')">
                        <div
                    ...
                    <div class="space-y-2 text-center">
                        ...
                        <p class="w-4/5 mx-auto text-sm font-light md:text-base">Lorem ipsum, dolor sit amet consectetur
                            adipisicing elit. Dolor, eligendi?</p>
                    </div>
                    <br>
                    <x-orange-button :href="route('promo.show',['slug'=>'product-1'])" :active="true">{{ __('Read More') }}</x-orange-button>
                </div>
            @endforeach
        </div>
